...
Ext.regModel('Page',
{
	...
	[
	 	...
	 	{name: 'enabled', type: 'boolean', defaultValue: true}, //hack
	 	{name: 'current', type: 'boolean', defaultValue: false},
	 	{name: 'showback', type: 'boolean', defaultValue: true},
	 	{name: 'shownext', type: 'boolean', defaultValue: true},
	 	{name: 'prevpage', type: 'boolean'},
	 	{name: 'nextpage', type: 'boolean'}	 	
	],
	belongsTo: 'Tutorial',
	...
	{
		this.visited=true;
		Ext.core.DomHelper.overwrite('page_title',this.number+'. '+this.title);
