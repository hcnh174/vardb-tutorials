/*global Ext, operon */
Ext.define('operon.tutorials.Question',
{	
	extend: 'operon.tutorials.Resource',
	
	constructor:function(tutorial,data)
	{	
		//operon.tutorials.Question.superclass.constructor.call(this);
		...
		{
			choice=new operon.tutorials.Choice(this,data.choices[index]);
